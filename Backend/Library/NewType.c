...
//
// DESCRIPTION
//    Creates a new PINFO structure, initializes it, and returns a pointer
//    to it.
//
// PARAMETERS
//    type           Special type code as defined in IFX.h (i.e.:IF_ARRAY).
//    ref1,ref2      Two integers that represent different things depending
...
//                   list which is also the new PINFO structure constructed.
//
/////////////////////////////////////////////////////////////////////////*/
